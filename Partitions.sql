...
select * from ineuron_course where course_lunch_year = 2020
...
partition p0 values less than ('aops',105,2019),
...
select ('aops',105,2019) > ('fsds',110,2021)

select ('vishal') < ('thorat')
